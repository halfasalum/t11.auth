...
class OfficerController extends Controller
{
    ...
    public function officerStats()
    {
        ...
        $results = $this->fetchStatisticsInParallel($zones);
     ...
     */
    private function fetchStatisticsInParallel(array $zones)
    {
        $allCustomers = 0;
        $activeCustomers = 0;
        $activeLoans = 0;
        ...
        $customerStats = CustomersZone::whereIn('zone_id', $zones)
        ...
        $loanStats = Loans::whereIn('zone', $zones)
            ->selectRaw('
